...
define('DB_NAME', 'GameDB'); // Wat is de database naam
define('DB_USER', 'ftpuser'); 		// Wat is de database gebruiker
define('DB_PASS', 'X3*>CQ%b$PS3h#cj');			// Wat is het database wachtwoord
...
define('DEFAULT_CONTROLLER', 'test'); // Dit is de standaard controller waarmee de webapplictie wordt opgestart
